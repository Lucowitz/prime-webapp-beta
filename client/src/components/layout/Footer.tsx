...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#121212] border-t border-white border-opacity-10 pt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">{t("footer.resources.mica")}</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">{t("footer.resources.support")}</a></li>
            </ul>
          </div>
          
          <div>
            <h4 className="font-heading font-bold text-lg mb-6">{t("footer.newsletter.title")}</h4>
            <p className="text-gray-400 mb-4">{t("footer.newsletter.desc")}</p>
            <form onSubmit={(e) => e.preventDefault()}>
              <div className="flex">
                <input 
                  type="email" 
                  placeholder={t("footer.newsletter.placeholder")} 
                  className="flex-grow px-4 py-2 bg-[#1E1E1E] border border-white border-opacity-10 rounded-l-md text-gray-300 focus:outline-none focus:ring-2 focus:ring-[#00FFD1]"
                />
                <button 
                  type="submit" 
                  className="bg-gradient-to-r from-[#0047AB] to-[#8A2BE2] hover:from-[#3373C4] hover:to-[#A45BF0] px-4 py-2 rounded-r-md font-medium text-white transition-all"
                >
      ...
      <div className="border-t border-white border-opacity-10 py-6 mt-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
